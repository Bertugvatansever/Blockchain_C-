...
namespace ConsoleApp1
{
	...
	},
	{
		...
		""type"": ""function""
            ...
            var productNames = _productNames; // Replace with product names
            var productTypes = _productTypes; // Replace with product types
            var productPrices = _productPrices; // Replace with product prices
            var productAmounts = _productAmounts; // Replace with product amounts
            ...
            var sellerSurnames = _sellerSurnames; // Replace with seller surnames
                                                                   //var transactionInput = purchaseFunction.CreateTransactionInput(buyerAddress, sellers, productNames, productTypes, productPrices, productAmounts, buyerName, buyerSurname, sellerNames, sellerSurnames);
